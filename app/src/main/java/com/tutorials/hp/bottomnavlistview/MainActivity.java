...
public class MainActivity extends AppCompatActivity implements AHBottomNavigation.OnTabSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Hacemos uso del bottom navigator de Aurel Huber
    ...
    private void createNavItems()
    {
        ...
        //Por default partimos con este tab, crime. 
        bottomNavigation.setCurrentItem(0);

    }

    @Override
    //En la versión anterior del gradle, el primer boolean es void y no hay return al final
    //Esto viene del implements AHBottomNavigation.OnTabSelectedListener del mainactivity
    public boolean onTabSelected(int position, boolean wasSelected) {
        //Mostramos el fragmento seleccionado por su posición. Caso 0, 1 y 2
        if(position==0)
        {
